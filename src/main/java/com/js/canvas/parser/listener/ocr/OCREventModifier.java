package com.js.canvas.parser.listener.ocr;
 ...
 */
public class OCREventModifier extends ChainableEventListener {
    ...
    public OCREventModifier(IOpticalCharacterRecognitionEngine opticalCharacterRecognitionEngine) {
            ...
            try {
                ...
                for (OCRChunk chunk : ocrChunkList) {
                    if (chunk.getText() != null && !chunk.getText().isEmpty()) {
                        ...
                        getNext().eventOccurred(textRenderInfo, EventType.RENDER_TEXT);
                    }
                }
